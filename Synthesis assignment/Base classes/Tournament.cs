...
namespace Synthesis_assignment.Base_classes
{
    public abstract class Tournament
    {
        ...
        public string SportType { get { return sportType; } }
        ...
        protected Tournament(int id, string description, DateTime startDate, DateTime endDate, int minPlayers, int maxPlayers, string location, int numGames)
        {
            this.id = id;
