...
namespace Synthesis_assignment.Base_classes
{
    public class Upcoming_tournament : Tournament
    {
        ...
        public Upcoming_tournament(int id, string description, DateTime startDate, DateTime endDate, int minPlayers, int maxPlayers, string location, int numGames, List<People> players) : base(id, description, startDate, endDate, minPlayers, maxPlayers, location, numGames)
        {
