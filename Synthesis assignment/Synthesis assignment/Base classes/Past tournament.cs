...
namespace SynthesisAssignment.Base_classes
{
    public class Past_tournament : Tournament
    {
        ...
        public Past_tournament(int id, string sportType, string description, DateTime startDate, DateTime endDate, int minPlayers, int maxPlayers, string location, int numGames, Dictionary<People, int> leaderboard) : base(id, sportType,description, startDate, endDate, minPlayers, maxPlayers, location, numGames)
        {
