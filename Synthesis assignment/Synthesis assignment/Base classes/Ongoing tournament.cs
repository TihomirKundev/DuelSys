...
namespace SynthesisAssignment.Base_classes
{
    public class Ongoing_tournament : Tournament
    {
        ...
        public Ongoing_tournament(int id, string sportType, string description, DateTime startDate, DateTime endDate, int minPlayers, int maxPlayers, string location, int numGames, Dictionary<People, int> leaderboard, List<Game> schedule) : base(id,sportType, description, startDate, endDate, minPlayers, maxPlayers, location, numGames)
        {
