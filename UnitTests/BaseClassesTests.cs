...
namespace UnitTests
{
    ...
    public class BaseClassesTests
    {
        ...
        {
            Game game = new Game(1, "tihomirkanedv@gmail.com", "gabrielgarbov@gmail.com", new int[3] { 21, 0, 0 }, new int[3] { 15, 0, 0 });
        ...
        {
            Game game = new Game(1, "tihomirkanedv@gmail.com", "gabrielgarbov@gmail.com", new int[3] { 21, 21, 0 }, new int[3] { 15, 15, 0 });
        ...
        {
            Game game = new Game(1, "tihomirkanedv@gmail.com", "gabrielgarbov@gmail.com", new int[3] { 21, 21, 21 }, new int[3] { 15, 15, 15 });
        ...
        {
            Game gameFinish = new Game(1, "tihomirkanedv@gmail.com", "gabrielgarbov@gmail.com", new int[3] { 21, 21, 21 }, new int[3] { 15, 15, 15 });
            Game gameUnfinish = new Game(2, "tihomirkanedv@gmail.com", "rosenstanchev@gmail.com", new int[3] { 21, 0, 0 }, new int[3] { 15, 0, 0 });
            Ongoing_tournament tournament = new Ongoing_tournament(2, "Test2", new DateTime(2022, 06, 06), new DateTime(2022, 07, 01), 3, 7, "Amsterdam", 3, new Dictionary<People, int>(), new List<Game>() { gameFinish,gameUnfinish});
        ...
        public void GetLeaderboard()
        {
            ...
            Ongoing_tournament tournament = new Ongoing_tournament(2, "Test2", new DateTime(2022, 06, 06), new DateTime(2022, 07, 01), 3, 7, "Amsterdam", 3, persons , new List<Game>());
        ...
        {
            Upcoming_tournament tournament = new Upcoming_tournament(2, "Test2", new DateTime(2022, 06, 06), new DateTime(2022, 07, 01), 3, 7, "Amsterdam", 3, new List<People>());
        ...
        public void AddExistingParticipant()
        {
            ...
            Upcoming_tournament tournament = new Upcoming_tournament(2, "Test2", new DateTime(2022, 06, 06), new DateTime(2022, 07, 01), 3, 7, "Amsterdam", 3, new List<People>() { people1});
            People people = new People("Tihomir", "Kandev", "tihomirkandev@gmail.com", "Tihomir1234");
