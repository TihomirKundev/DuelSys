...
namespace UnitTests
{
    ...
    public class TournamentManagerTests
    {
        ...
        public void CreateTournament()
        {
            ...
            Upcoming_tournament tournament = new Upcoming_tournament(10,"Test", new DateTime(2022, 06, 25), new DateTime(2022, 07, 10), 4, 8, "Eindhoven", 1, new List<People>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Upcoming_tournament tournament = new Upcoming_tournament(1, "Test", new DateTime(2022, 06, 25), new DateTime(2022, 07, 10), 4, 8, "Eindhoven", 1, new List<People>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Tournament tournament = new Past_tournament(3, "Test4", new DateTime(2022, 05, 20), new DateTime(2022, 06, 05), 5, 15, "Best", 5, new Dictionary<People, int>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Tournament tournament = new Canceled_tournament(4, "Test5", new DateTime(2022, 05, 22), new DateTime(2022, 06, 02), 5, 15, "Best", 5, new List<People>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Tournament tournament = new Upcoming_tournament(1, "Test2", new DateTime(2022, 06, 26), new DateTime(2022, 07, 11), 4, 8, "Eindhoven", 3, new List<People>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Tournament tournament = new Ongoing_tournament(2, "Test3", new DateTime(2022, 06, 06), new DateTime(2022, 07, 11), 3, 7, "Amsterdam", 3, new Dictionary<People, int>(), new List<Game>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Tournament tournament = new Upcoming_tournament(10, "Test3", new DateTime(2022, 06, 06), new DateTime(2022, 07, 11), 3, 7, "Amsterdam", 3, new List<People>());
        ...
        {
            TournamentManager tournamentManager = new TournamentManager(new MockUploadTournament());
            Tournament tournament = new Upcoming_tournament(1, "Test3", new DateTime(2022, 06, 06), new DateTime(2022, 07, 11), 3, 7, "Amsterdam", 3, new List<People>());
